<template>
  <div class="item-div">
    ...
    <el-tabs v-model="dynamicValidateForm.activeName" class="demo-tabs" @tab-click="handleClick">
    ...
    <el-form
    :label-position="'left'"
    :label-width="dynamicValidateForm.activeName === 'first'? '40px':'70px'"
    ref="formRef"
    class="demo-dynamic">
    <el-form-item
      label="账号"
    ...
    <el-form-item label="密码确认"  v-if="dynamicValidateForm.activeName === 'second'">
<el-input v-model="dynamicValidateForm.confirm_password"  type="password"/>
</el-form-item>
    </el-form>
    <el-button type="primary" class="btn" @click="submitForm()" v-if="dynamicValidateForm.activeName === 'first'">登录</el-button>
    <el-button type="primary" class="btn" @click="submitRegisterForm()" v-if="dynamicValidateForm.activeName === 'second'">注册</el-button>
...
function handleClick(){
  ...
  console.log(dynamicValidateForm.value.activeName,dynamicValidateForm.value.adminName)
...
function valid(){
  ...
  if(dynamicValidateForm.value.password !== dynamicValidateForm.value.confirm_password){
...
async function submitForm()  {
    console.log('submit data is ',dynamicValidateForm.value.userName, dynamicValidateForm.value.password)
