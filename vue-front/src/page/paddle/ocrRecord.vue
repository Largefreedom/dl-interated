    ...
    <div class="ocr-records">
        <el-table :data="table.data"  style="width: 100%"  >
            ...
            <el-table-column  label="操作"  align="center" >
                <template #default="scope">
                  <a @click="viewItem(scope.row)" style="color:blue;cursor: pointer;"> 查看</a>
                  <a @click="deleteItem(scope.row.id)" style="color:blue;cursor: pointer;margin-left: 8x;"> 删除</a>
                </template>
            </el-table-column> 
        </el-table>
    ...
    @close="closeData">
        <div class="diag-con">
            ...
            <div>
                ...
                <span style="color:red;font-weight: bold; font-size: 18px;">{{ table.form.data.is_sen }}</span>
            </div>
            ...
            <div>
                ...
                <span style="color:red; font-size: 18px;">{{ table.form.data.sen_txt}}</span>
            </div>
        </div>
    </el-dialog>
